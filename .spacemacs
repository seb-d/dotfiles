...
you should place your code here."
  ...
  ;; (global-set-key '[f2] 'langtool-check)
  ;; (global-set-key '[f3] 'langtool-correct-buffer)
  ;; (global-set-key '[f4] 'langtool-check-done)
  (global-set-key '[f5] 'auto-revert-mode)
  (global-set-key '[f7] 'indent-region)
  (global-set-key '[f8] 'compile)
  (global-set-key '[f9] 'query-replace-regexp)
  (global-set-key '[f10] 'serach-forward-regexp)
  ...
  (global-set-key '[f12] 'fd-switch-dictionary)
  ;; (setq langtool-language-tool-server-jar "PATH/TO/JAR")
  ;; (setq langtool-server-user-arguments '("-languageModel" "PATH/TO/LANG"))
  ;; (require 'langtool)
  )
